    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-8">
              <ScrappyDog size={28} />
              <span className="text-emerald-100 text-sm font-medium">Meet Scrappy, your recycling sidekick</span>
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 tracking-tight leading-tight">
              Your scrap.<br />Their hustle.<br />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="flex items-center justify-center gap-3 text-center md:text-left">
              ...
              <div>
                <p className="text-emerald-300 font-semibold text-sm">76% of recyclables never leave the home</p>
              </div>
            </div>
            <div className="flex items-center justify-center gap-3 text-center md:text-left">
              <div className="w-10 h-10 bg-emerald-800 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <section className="bg-emerald-600 py-16">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <ScrappyDog size={64} />
          <h2 className="text-3xl font-bold text-white mt-6 mb-4">Ready to turn scrap into cash?</h2>
          <p className="text-emerald-100 mb-8 text-lg">Join the circular economy. Whether you have scrap to give or a truck to fill, Scrappr connects the dots.</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={() => navigate('/scrappee')}
...
function Step({ num, icon, title, desc }: { num: number; icon: React.ReactNode; title: string; desc: string }) {
  return (
    <div className="flex gap-4">
      ...
      <div>
        <div className="text-xs font-semibold text-emerald-500 uppercase tracking-wide mb-1">Step {num}</div>
