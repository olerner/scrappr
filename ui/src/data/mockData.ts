...
export const PREP_CHECKLIST_CATEGORIES = ['Appliances', 'Lawnmowers'];
...
export const MOCK_LISTINGS: Listing[] = [
  ...
  },
  {
    id: '6',
    category: 'Appliances',
    description: 'Large 50-gallon water heater. Heavy, will need two people or a dolly. Garage pickup.',
